...
jfolder = fullfile(mrstPath('query', 'mrst-testing'), 'output', 'XML');
if exist(jfolder, 'dir')
    rmdir(jfolder, 's')
end

tap_folder = fullfile(mrstPath('query', 'mrst-testing'), 'output', 'JUnit');
if exist(tap_folder, 'dir')
    rmdir(tap_folder, 's')
end

mrstModule add mrst-testing ad-core ad-blackoil

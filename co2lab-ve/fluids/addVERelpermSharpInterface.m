function fluid = addVERelpermSharpInterface(fluid, Gt, rock, varargin)
    ...
    [fluid.res_gas, fluid.res_water] = deal(opt.res_gas, opt.res_water);
    [krw, krg] = deal(ifelse(isempty(opt.krw), 1-opt.res_gas, opt.krw), ...
                      ifelse(isempty(opt.krg), 1-opt.res_water, opt.krg));

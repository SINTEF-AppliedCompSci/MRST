...
params = addParameter([], setup, 'name', 'perm', ...
                      'belongsTo', 'model', ...
                      'location', {'model', 'rock', 'perm'}, ...
                      'setfun', @setPermeabilityFun, ...
                      'relativeLimits', [0.5 12], 'scaling', log);
params = addParameter(params, setup, 'name', 'porevolume', 'relativeLimits', [0.5 1.4])
params = addParameter(params, setup, 'name', 'rhoGS', ...
                      'belongsTo', 'model', ...
                      'location', {'model', 'fluid', 'rhoGS'}, ...
                      'setfun', @setrhoGSfun, ...
                      'relativeLimits' , [0.5, 2], 'scaling', 'log'); % @@@
params = addParameter(params, setup, 'name', 'rate', 'relativeLimits', [0.1 1.5]); % @@@
params = addParameter(params, setup, 'name', 'dz', ...
                      'belongsTo', 'model', ...
                      'location', {'model', 'grid', 'dz'}, ...
                      'relativeLimits', [-5, 5], 'uniformLimits', true);

function [sw_kr, krw, kro] = van_genuchten_burdine_kr(swc, sor, krwSor, kroSwc, n_kr)
% <keywords>
%
% Purpose : create a relative permeability table based on van genuchten burdine integral
%
% Syntax :

function model = CreateGrid2(model)
    ...
    dx0 = length / nCells / 10;

    m = nCells / 2;
    xL = logspace(log10(dx0),log10(length/2),m);
    ...
    dx = diff(x);
    area = pi * experiment.geometry.diameter.value ^ 2 / 4;

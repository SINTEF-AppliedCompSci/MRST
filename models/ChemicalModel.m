classdef ChemicalModel < PhysicalModel
    ...
    methods
        ...
        %%
        function [state, report, model] = initState(model, state, userInput)
        % set up inputState from userInputState, which means

            % make a check to see if initElectrostaticModel has been called
            % or assume langmuir

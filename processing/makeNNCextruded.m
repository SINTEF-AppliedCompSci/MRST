function [Gl,T] = makeNNCgrid(G,Gl,F,fracture,flayers)
%
nfl = numel(flayers);
...
w1 = Gl.cells.volumes(Gl.nnc.cells(:,1))./Gl.rock.perm(Gl.nnc.cells(:,1));
w2 = Gl.cells.volumes(Gl.nnc.cells(:,2))./Gl.rock.perm(Gl.nnc.cells(:,2));
wt = Gl.cells.volumes(Gl.nnc.cells(:,1))+Gl.cells.volumes(Gl.nnc.cells(:,2));

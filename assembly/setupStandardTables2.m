...
%}
    ...
    cellnodeface2vectbl = crossIndexArray(cellnodeface2tbl, vectbl, {}, 'virtual', useVirtual);
    ...
    cellvec12tbl = crossIndexArray(celltbl, vec12tbl, {}, 'virtual', ...
                                    useVirtual);
    cellnodevec12tbl = crossIndexArray(cellnodetbl, vec12tbl, {}, 'virtual', ...
                                        useVirtual);
    cellnodefacevec12tbl = crossIndexArray(cellnodefacetbl, vec12tbl, {}, ...
                                            'virtual', useVirtual);
    nodefacevec12tbl = crossIndexArray(nodefacetbl, vec12tbl, {}, ...
                                           'virtual', useVirtual);
    ...
    tbls = struct('vectbl'              , vectbl              , ...
                  ...
                  'cellnodeface2vectbl' , cellnodeface2vectbl , ...

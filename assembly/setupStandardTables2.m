...
%}
    ...
    cellnodeface12tbl = gen.eval();
    
    cellnodeface12vec12tbl = crossIndexArray(cellnodeface12tbl, vec12tbl, {}, 'virtual', useVirtual);
    ...
    nodeface12tbl = gen.eval();
    
    nodeface12vec12tbl = crossIndexArray(nodeface12tbl, vec12tbl, {}, 'virtual', useVirtual);

    map = TensorMap();
    map.fromTbl = cellnodefacetbl;
    map.toTbl = cellnodeface12tbl;
    map.replaceFromTblfds = {{'faces', 'faces1'}};
    map.mergefds = {'cells', 'nodes', 'faces1'};
    
    cellnodeface_1_from_cellnodeface12 = map.getDispatchInd();
    ...
    cellnodeface_2_from_cellnodeface12 = map.getDispatchInd();
    ...
    cellnodefacevec12tbl = crossIndexArray(cellnodefacetbl, vec12tbl, {}, 'virtual', useVirtual);
    nodefacevec12tbl     = crossIndexArray(nodefacetbl, vec12tbl, {}, 'virtual', useVirtual);
    nodevec12tbl         = crossIndexArray(nodetbl, vec12tbl, {}, 'virtual', useVirtual);
    ...
    cellvec1212tbl = crossIndexArray(celltbl, vec1212tbl, {}, 'optpureproduct', ...
        true);
    cellnodevec1212tbl = crossIndexArray(cellnodetbl, vec1212tbl, {}, ...
                                          'virtual', useVirtual);
    ...
    tbls = struct('vectbl'                , vectbl                , ...
                  ...
                  'vec12tbl'              , vec12tbl              , ... 
                  'nodevec12tbl'          , nodevec12tbl          , ... 
                  'nodefacevec12tbl'      , nodefacevec12tbl      , ...
                  'vec1212tbl'            , vec1212tbl            , ...
                  'facevectbl'            , facevectbl            , ...
                  'cellfacevectbl'        , cellfacevectbl        , ...
                  'cellvec1212tbl'        , cellvec1212tbl        , ...
                  'cellnodevec1212tbl'    , cellnodevec1212tbl    , ...
                  'cellnodeface12tbl'     , cellnodeface12tbl     , ...
                  'cellnodeface12vec12tbl', cellnodeface12vec12tbl, ...
                  'nodeface12tbl'         , nodeface12tbl         , ...
                  'nodeface12vec12tbl'    , nodeface12vec12tbl    , ...
    ...
    mappings = struct('cell_from_cellnode'                , cell_from_cellnode                , ...
                      ...
                      'cellnodeface_1_from_cellnodeface12', cellnodeface_1_from_cellnodeface12, ... 
                      'cellnodeface_2_from_cellnodeface12', cellnodeface_2_from_cellnodeface12, ... 

function [description, options, state0, model, schedule, plotOptions] = pinn_da_case_const_perm(varargin)
...
%}
    ...
    % and options
    description = 'PINN DA case - constant permeability';

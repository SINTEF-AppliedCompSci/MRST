...
cfErr = norm(cflux - stateMPFA.flux)/norm(stateMPFA.flux);
fprintf('2D 1st order: \t pressure error: \t %5.2f %%\t', pErr*100);
fprintf('flux error: \t %6.2f%%\t ', fErr*100);
fprintf('conserved flux error: \t %6.2f%%\t ', cfErr*100);
...
K = diag(100*milli*darcy*[1,1,1],0);

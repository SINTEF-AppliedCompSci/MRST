classdef ExplicitOilWaterSurfactantModel1 < TwoPhaseOilWaterModel
...
% component in addition.
   ...
   methods
      function model = ExplicitOilWaterSurfactantModel1(G, rock, fluid, varargin)
         ...
         model.explConcModel = ExplicitSurfactantModel1(G, rock, fluid, varargin{:});

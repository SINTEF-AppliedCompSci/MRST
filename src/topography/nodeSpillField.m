...
%     boundary_nodes = identify_boundary_nodes(node_neighbors); % one entry per node
...
%     region(boundary_nodes) = 0;             % All boundary nodes considered to be part of the
%                                            % 'exit' region. 
%     uslp_neigh(boundary_nodes) = 0;         % We do not track upslope  neighbors for boundary
%                                            % nodes.

...
% Plot well curves
fh = plotWellSols({wellSolsRef,wellSols_0}, ...
...
[~,~,wellSols_0]   = evaluateMatch(pvec0,mismatchFn,prob,parameters, statesRef,'Gradient','none');

%% Plot well curves
fh = plotWellSols({wellSolsRef,wellSols_0,wellSols_opt}, ...

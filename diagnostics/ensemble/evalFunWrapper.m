function status = evalFunWrapper(fn, args, varargin)
...
%                    using single computatinal thread (default false)
%
...
%
% EXAMPLE:
%   evalFunWrapper(@bar, {[1 2 3], [1 2 1.5], 'r'}, 'exitWhenDone', false)
%
% SEE ALSO
% evalFunStandalone
...
% chech that function is anonymous

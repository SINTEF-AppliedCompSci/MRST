classdef chargeBalanceModel_nonLog < ChemicalInputModel
    ...
    methods
        ...
        function model = chargeBalanceModel_nonLog()
        ...
        function [problem, state] = getEquations(model, state0, state, dt, drivingForces, varargin)
            ...
            [eqs, names, types] = equationsChargeBalance_nonLog(model, state, components, masterComponents, combinationComponents,...
        ...
        function [unknowns, components, masterComponents, combinationComponents,...
            ...
            CNames = model.speciesNames;
            MCNames = model.elementNames;
            LCNames = model.combinationNames;
            GNames = model.gasNames;
            SNames = model.solidNames;
            SPNames = model.surfaceActivityCoefficientNames;

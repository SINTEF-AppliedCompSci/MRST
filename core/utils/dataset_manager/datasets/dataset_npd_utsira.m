...
% Info function for the Norwegian Offshore Directorate Utsira dataset
%
...
%}
    ...
    [info, present] = datasetInfoStruct(...
        ...
        'fileurl', 'https://www.sodir.no/globalassets/1-sodir/fakta/co-to/lagringsmodeller/nordsjoen/utsira.zip', ...
        'hasGrid', true, ...
        'hasRock', true, ...
        'hasFluid', true, ...
        'cells',   111162, ...

...
%}
    ...
    testFiles = {
        ...
        fullfile(root, 'utils', 'tests', 'ADITest.m'), ...
        fullfile(root, 'gridprocessing', 'tests', 'CartGridGeometryTest.m'), ...
        fullfile(root, 'solvers', 'tests', 'TransmissibilityTest.m'), ...
        fullfile(root, 'params', 'wells_and_bc', 'tests', 'AddWellTest.m'), ...
        fullfile(root, 'solvers', 'tests', 'StateInitializationTest.m'), ...
    };

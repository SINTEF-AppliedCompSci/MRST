% script to generate left panel of Figure 4 of paper
% It plots the density of CO2 as function of depth with a given thermal
% gradient of 30 K / km with 12 C at the h = 0 and assuming hydrostatic
% conditions.
gravity on
rhoW = 1100; % brine density
z = linspace(300, 3000, 100)'; % values to plot
dz = 600; % max(Gt.cells.z) - min(Gt.cells.z) max change in aquifer
Temp = z * 30 / 1e3 + 274 + 12; % temperature profile

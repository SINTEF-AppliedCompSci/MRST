mrstModule add dg ad-props ad-core ad-blackoil blackoil-sequential ...
    mrst-gui matlab_bgl vem vemmech vista upr compositional
mrstVerbose on
...
setup = getDGTestCase('qfs_wo_2d', 'useMomentFitting', true, 'nkr', 1); %#ok
...
setup = getDGTestCase('spe10_wo', 'useMomentFitting', true); %#ok

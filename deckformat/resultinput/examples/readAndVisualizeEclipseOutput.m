...
% from *.INIT and *.EGRID. Unconverted grid properties from *INIT and *UNRST 
% (restart data) are plotted using plotToolBar. Summary data (*UNSMRY) is read 
% and inspected.
...
% only portions of the restart data. Here er read all data for for time-steps
% 1 through 20.

...
%% Quantities to vary:                        %%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
n = 50;    % number of cells in x-direction
L = 2000;  % physical dimension in x-direction
dy = 1000; % physical dimension in y-direction
volume = 0.1e6; h0=5; 
...
% define z-coordinates according to theta
...
% Refine most in upper part of grid: 
if refine
...
%% Corresponding grid with theta = 0 for plotting of saturations
plotGrid(g_plot); view([0 0])
xlabel('x'), ylabel('y'), zlabel('z')
title('Grid for plotting')
...
fluid_mrst = initSimpleFluid('mu', [ 0.1,  0.4]*centi*poise, 'rho', [600 1000], 'n', [n_flux n_flux]);

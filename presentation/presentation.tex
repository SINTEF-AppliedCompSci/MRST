  ...
  \only<1>{
    \begin{columns}
      \begin{column}{0.65\textwidth}
        ...
        \item Most physical gases does not form a completely miscible system when combined
          with reservoir oil
        \end{prettyList}
      \end{column}
...
\begin{frame}
 ...
 \begin{textblock}{10}(6,7.5)
    ...
    \item No need to calculate Jacobians explicitly

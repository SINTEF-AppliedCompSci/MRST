...
% Description: This MRST example models underground hydrogen storage with microbial
...
if ~nobact
    ...
    %% Plot Results
    plotBenchmarckAEGE2023(nT,pressure_nbs0,pressure_bs0,H2_loss_percentage_nbs0,...

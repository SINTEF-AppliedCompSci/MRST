classdef ECPAGenericOverallCompositionModelDP < ECPAOverallCompositionCompositionalModelDP & GenericReservoirModel
    properties
        
    end
    
    methods
        function model = ECPAGenericOverallCompositionModelDP(varargin)
            model = model@ECPAOverallCompositionCompositionalModelDP(varargin{:});
        ...
        function model = validateModel(model, varargin)
            ...
            model = validateModel@ECPAOverallCompositionCompositionalModelDP(model, varargin{:});
        end
        
        function model = setupStateFunctionGroupings(model, varargin)
            model = setupStateFunctionGroupings@ECPAOverallCompositionCompositionalModelDP(model, varargin{:});

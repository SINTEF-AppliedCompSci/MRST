classdef ECPAGenericNaturalVariablesModelDP < ECPANaturalVariablesCompositionalModelDP & GenericReservoirModel
    properties
        
    end
    
    methods
        function model = ECPAGenericNaturalVariablesModelDP(varargin)
            model = model@ECPANaturalVariablesCompositionalModelDP(varargin{:});

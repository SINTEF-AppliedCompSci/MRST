...
if strcmp(model_name, 'DP')
    ...
    natural= NaturalVariablesCompositionalModelDP(G, {rock_fracture,rock_matrix},...
        {fluid_fracture,fluid_matrix},...
        mixture,...
        'water',false, 'oil',true, 'gas', true,...
        'liquidPhase', 'O', 'vaporPhase', 'G',...
        'AutoDiffBackend', diagonal_backend);
    overall = OverallCompositionCompositionalModelDP(G, {rock_fracture,rock_matrix},...
        {fluid_fracture,fluid_matrix},...
        mixture,...
        'water',false, 'oil',true, 'gas', true,...
        'liquidPhase', 'O', 'vaporPhase', 'G',...
...
elseif strcmp(model_name, 'DPDP')
    ...
    % the matrix and fracture regions
    natural= NaturalVariablesCompositionalModelDPDP(G, {rock_fracture,rock_matrix},...
        {fluid_fracture,fluid_matrix},...
        mixture,...
        'water',false, 'oil',true, 'gas', true,...
        'liquidPhase', 'O', 'vaporPhase', 'G',...
        'AutoDiffBackend', diagonal_backend);
    overall = OverallCompositionCompositionalModelDPDP(G, {rock_fracture,rock_matrix},...
        {fluid_fracture,fluid_matrix},...
        mixture,...
        'water',false, 'oil',true, 'gas', true,...
        'liquidPhase', 'O', 'vaporPhase', 'G',...
...
natural.transfer_model_object = KazemiSinglePhaseTransferFunction('KazemiShapeFactor',...
                                                                 [1,1,1]);
%% Initializing state
state = initCompositionalStateDP(overall, p, T, [], z);

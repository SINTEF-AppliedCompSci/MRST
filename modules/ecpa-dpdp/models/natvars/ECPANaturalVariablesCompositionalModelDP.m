classdef ECPANaturalVariablesCompositionalModelDP < ECPAThreePhaseCompositionalModelDP
    ...
    methods
        function model = ECPANaturalVariablesCompositionalModelDP(G, rock, fluid, mixture, varargin)
        ...
        function [problem, state] = getEquations(model, state0, state, dt, drivingForces, varargin)
            [problem, state] = eCPAequationsNaturalVariablesDP(state0, state, model, dt, ...

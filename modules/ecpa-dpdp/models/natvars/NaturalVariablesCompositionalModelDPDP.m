classdef NaturalVariablesCompositionalModelDPDP < ThreePhaseCompositionalModelDP
    ...
    methods
        function model = NaturalVariablesCompositionalModelDPDP(G, rock, fluid, mixture, varargin)
        ...
        function [problem, state] = getEquations(model, state0, state, dt, drivingForces, varargin)
            [problem, state] = equationsNaturalVariablesDPDP(state0, state, model, dt, ...
        ...
        function state = validateState(model, state)
            state = validateState@ThreePhaseCompositionalModelDPDP(model, state);

...
model = constructor(arg{:}, 'AutoDiffBackend', mex_backend);
...
%% Pick linear solver
linsolve = selectLinearSolverAD(model,'useAMGCL',false,'useCPR',false);
disp(linsolve)
...
%% Simulate problem
[ws, states, reports] = simulateScheduleAD(state, model, schedule,'nonlinearsolver', nls,'Verbose', true);
%% plotting

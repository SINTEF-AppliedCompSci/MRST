...
%}
    ...
    command = sprintf('python3 /home/elyes/Documents/Projects/MRST/modules/H2store/thermodymics/python_scripts/make_solubility_table_H2_salt.py -t1 %.1f -t2 %.1f -nt %d -p1 %.1f -p2 %.1f -np %d -sm %.1f -o %s', ...

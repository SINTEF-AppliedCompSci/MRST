function [p_opt, history] = improvedCalibration(pvec_init, objh, objh2, objh2_new, varargin)
    ...
    [~, p_opt, hist1] = unitBoxBFGS(p_opt, objh, 'objChangeTol', objTol, 'maxIt', 15);
    history_main = appendHistory(history_main, hist1);

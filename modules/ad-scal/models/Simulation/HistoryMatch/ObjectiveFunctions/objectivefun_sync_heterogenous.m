function total_error = objectivefun_sync_heterogenous(x, model_flooding, ...
    model_cent)
%
% DESCRIPTION: defines the objective function including the simultaneous
%              case, and heterogeneity for single objective optimization
%              using fmincon
%
% SYNOPSIS:
%   total_error = objectivefun_sync_heterogenous(x, model_flooding, ...
%     model_cent)
%
% PARAMETERS:

...
%     splitAtInt
% 
% - clippedPebiGrid2D creates a clipped Voronoi diagram. 
%
% - createCVD creates a centroidal Voronoi diagram by minimizing the 
%   CVD energy function. It does this by using the L-BFGS optimization
%   algorithm.
% 

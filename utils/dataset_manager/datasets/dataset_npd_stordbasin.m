...
% Info function for the Norwegian Offshore Directorate Stord Basin dataset
%
...
%}
    ...
    [info, present] = datasetInfoStruct(...
        ...
        'fileurl', 'https://www.sodir.no/globalassets/1-sodir/fakta/co-to/lagringsmodeller/nordsjoen/stordbasin.zip', ...
        'hasGrid', true, ...
        'hasRock', true, ...
        'hasFluid', true, ...
        'cells',   106365, ...

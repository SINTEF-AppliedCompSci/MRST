...
%}
    [info, present] = datasetInfoStruct(...
        ...
        'hasFluid', false, ...
        'cells', 78720, ...
        'description','The SAIGUP project generated a large number of realistic geological models representing shallow marine environtments. This model is one specific realization that has faults, inactive cells, disconnected components, but no pinchouts.',... 
        'filesize',    2.535, ...

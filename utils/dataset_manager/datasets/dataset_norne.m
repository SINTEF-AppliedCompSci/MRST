...
%}
    ...
    [info, present] = datasetInfoStruct(...
        ...
        'description', 'Real world field model in the Norwegian Sea operated by Statoil. Available to researchers via the Norwegian University of Science and technology. ', ...

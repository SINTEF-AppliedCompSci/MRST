...
% Info function for the Norwegian Offshore Directorate Egersund dataset
%
...
%}
    ...
    [info, present] = datasetInfoStruct(...
        ...
        'fileurl', 'https://www.sodir.no/globalassets/1-sodir/fakta/co-to/lagringsmodeller/nordsjoen/egersund.zip', ...
        'hasGrid', true, ...
        'hasRock', true, ...
        'hasFluid', true, ...
        'cells',   105310, ...

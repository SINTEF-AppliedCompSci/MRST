...
if str2double(v(1:4))<2015
    warning('mrst:versionIncompatibleForHFMmodule', ...
        ['The matlab version installed on your computer is less than 2015a. \n\n'...
        'Please download matlab version 2015a or higher for complete '...
        'functionality with the HFM module. \nLower versions of matlab '...
        'do not support the functions ''ismembertol'' and ''uniquetol'' '...
        'and this may result in errors while identifying fracture-matrix '...
        'connections and computing the fracture grid. Additionally, '...
        'lower versions do not support the triangulation feature which '...
        'is required to run 3D examples.']);
end

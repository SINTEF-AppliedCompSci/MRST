...
%}
    ...
    titl = uicontrol(infoPanel, 'Units', 'normalized', ...
                 'Position', [0, .9, 1, .075],...
                 'Style', 'text',...
                 'HorizontalAlignment', 'center', 'FontSize', 20);

    descr = uicontrol(infoPanel, 'Units', 'normalized', ...
                 'Position', [0, .4625, 1, .4625],...
                 'Style', 'edit',...
                 'min', 0, 'max', 1e3, ...
                 'HorizontalAlignment', 'left');

    extext = uicontrol(infoPanel, 'Units', 'normalized', ...
                 'Position', [0, .4025, 1, .060],...
                 'Style', 'text',...
                 'HorizontalAlignment', 'center', 'FontSize', 18);

    exinfo = uicontrol(infoPanel, 'Units', 'normalized', ...
                 'Position', [0, 0, 1, .4025],...
                 'Style', 'edit',...
                 'min', 0, 'max', 1e3, ...
                 'HorizontalAlignment', 'left');

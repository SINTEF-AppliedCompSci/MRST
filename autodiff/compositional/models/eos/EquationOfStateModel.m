classdef EquationOfStateModel < PhysicalModel
    ...
    methods
        ...
        function L = singlePhaseLabel(eos, p, T, z, Z_L, Z_V) %#ok<INUSD>
        ...
        function [A_ij, Bi] = getLiquidMixingParameters(model, P, T, acf, useCell)
            % Get mixing parameters for the liquid phase. By default,
            % identical to getMixingParameters. Subclasses (e.g.,
            % SoreideWhitsonEos) may override to use different mixing
            % rules for the liquid phase.

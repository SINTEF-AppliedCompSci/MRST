classdef PhaseMixingCoefficientsLV < StateFunction
    ...
    methods
        ...
        function v = evaluateOnDomain(prop, model, state)
            ...
            [A_ij_L, Bi_L] = eos.getLiquidMixingParameters(p, T, acf, iscell(x));
            [Si_L, A_L, B_L] = eos.getPhaseMixCoefficients(x, A_ij_L, Bi_L);
            v{L_ix} = struct('Si', {Si_L}, 'A', {A_L}, 'B', {B_L}, 'Bi', {Bi_L}, 'A_ij', {A_ij_L});

function dT = rampupTimesteps(time, dt, n, varargin)
...
%}
    ...
    % Threshold is used to remove very small step that can be generated by round-off error
    opt = struct('threshold_error', 1e-6);
    ...
    % negative time-step.
    if dt_final/dt_rem(end) <= opt.threshold_error

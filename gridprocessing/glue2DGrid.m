...
% Merge grid faces given in first column of 'merge' with the corresponding
% faces given by the second column.  Leave both faces in place (although
% one will remain unused).  (Unused faces can be purged later by a call to

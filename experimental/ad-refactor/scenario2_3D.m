function scenario2_3D(savename)
    ...
    state = ...
        struct('pressure', hpress(G.cells.centroids(:,3)), ...
               's', computeSaturation(G, mass_profile, EOS, tinfo, fluid, rock.poro));
...
function s = computeSaturation(G, mass_profile, EOS, tinfo, fluid, poro)

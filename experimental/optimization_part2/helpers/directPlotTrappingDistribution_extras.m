function directPlotTrappingDistribution_extras(ax, report, varargin)
...
%     % Explicitly set any negative values of leakage to 0 to avoid strange
%     % plotting behavior that can occur
%     tmp_leak                        = mass_hist(:,8);
%     tmp_leak( mass_hist(:,8) < 0 )  = 0;
%     mass_hist(:,8)                  = tmp_leak;

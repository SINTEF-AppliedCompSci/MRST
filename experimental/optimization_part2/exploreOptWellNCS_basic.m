...
for i=1:numel(names)
    ...
    for r = 1:numel(cp)
        ...
        'schedule'                       , sch, ...%'/home/rebeccaa/Documents/MATLAB/mrst-bitbucket/Synthetic_toKeep_correctScaling/InjYrs30_MigYrs500_noResTrap_optimized_cp2_futLeak_IR0pt5/optim', ...%sch                          , ... % can also pass in path of a previously saved schedule
            'itime'                      , 10 * year                    , ...
            'isteps'                     , 10                           , ...
            'mtime'                      , 300 * year                  , ...
            'msteps'                     , 30                          , ... 
        ...
        'well_placement_type'            , 'one_per_trap'               , ... % options: 'use_array', 'one_per_trap', 'one_per_path'
            'max_num_wells'              , 1                           , ... % used in use_array, one_per_trap
        ...
        'account_well_cost'              , true                         , ...
            ...
            'alpha'                      , 1                            , ... % i.e., tanh(q/(alpha*q_crit))
    ...
    if exist('other','var')
        subVarDirName = [fmName '_assessWellCost_updatedObjFun' '/' ...
            ...
            'WellInvestCost_',num2str(other.opt.well_initial_cost), '/' ...
            'alpha_',num2str(other.opt.alpha), '/' ...

...
[G, rock, fluid, state0, schedule] = setupThreephasePEBI('n', 20, 'dt', 20*day, 'nRampup', 8);
...
setup.model.FluxDiscretization.discritizeRelPerm = true;
setup.model.FluxDiscretization.discritizeViscosity = true;

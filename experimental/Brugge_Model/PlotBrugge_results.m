...
for i = 1:130
     for p = 11:30
        qw_ref(i,p-10) = wellSols_ref{i}(p).qWs;
        qo_ref(i,p-10) = wellSols_ref{i}(p).qOs;
        qw_0(i,p-10) = wellSols_0{i}(p).qWs;
        qo_0(i,p-10) = wellSols_0{i}(p).qOs;
        qw_pred(i,p-10) = wellSols_opt{i}(p).qWs;
        qo_pred(i,p-10) = wellSols_opt{i}(p).qOs;
     end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%555555
 ...
 T = cumsum(dt(1:65))/day; %your point goes here 

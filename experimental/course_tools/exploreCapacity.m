...
%       line 
   ...
   var.co2 = CO2props('sharp_phase_boundary', true, 'rhofile', 'rho_big_trunc');
...
function names = formation_names()
   ...
   names = {'Brentgrp', 'Brynefm', 'Cookfm', 'Fensfjordfm', ...
            'Gassumfm', 'Huginfm', 'Johansenfm', 'Krossfjordfm', ...
            'Paleocene', 'Pliocenesand', 'Sandnesfm', 'Skadefm', 'Sleipnerfm', ...
            'Sognefjordfm', 'Statfjordfm', 'Ulafm', 'Utsirafm'};     
end

classdef BlackOilFixedStressBiotModel < BlackOilBiotModel
    ...
    methods
        function model = BlackOilFixedStressBiotModel(G, rock, fluid, varargin)
            model = model@BlackOilBiotModel(G, rock, fluid);

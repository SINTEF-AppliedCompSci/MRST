    ...
    methods
        ...
        function [problem, state] = getEquations(model, state0, state, dt, ...
            ...
            if ~opt.resOnly,
                ...
                [p, sW, x, qWell{:}, bhp, wellVars{:}, xd] = initVariablesADI(p, ...
                                                                  sW, x, ...
                                                                  qWell{:}, ...
                                                                  bhp, ...
                                                                  wellVars{:}, ...
            ...
            [blackoileqs, state] = equationsBlackOilBiot(state0, st0, p, sW, ...
                                                         x, rs, rv, st, qWell, ...
                                                         bhp, wellVars, state, ...
                                                         model, dt, mechTerm, ...
                                                         drivingForces, ...
                                                         'iteration', ...
                                                         opt.iteration);
            mecheqs = equationsMechanicBiot(xd, fluidp, model.G, model.rock, ...
                                            model.operators);

function [ model, schedule, initState, states, wellSols ] = calibrateSleipnerSetup( varargin )
...
%}
    ...
    [opt.wellXcoord, opt.wellYcoord] = deal(4.38516e5, 6.47121e6);  
    ...
    moduleCheck('co2lab-ve', 'co2lab-common', 'ad-core', 'deckformat', ...
    ...
    % add top surface height modifiers (to allow adjustment/optimization
    Gt.dz = zeros(Gt.cells.num, 1);
    ...
    fluid = makeVEFluid(Gt, rock2D, 'sharp_interface_simple', ...
        'reservoirT'  , caprock_temperature, ...
        'wat_mu_ref'  , mu(1), ...
        'co2_mu_ref'  , mu(2), ...
    ...
    states = addHeightData(states, Gt, fluid); % for easier plotting

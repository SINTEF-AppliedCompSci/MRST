...
reports_init  = makeReports(Gt, init.states, other.rock, other.fluid, init.schedule, ...
                            other.residual, other.traps, other.dh);

reports_optim = makeReports(Gt, optim.states, other.rock, other.fluid, optim.schedule, ...
                      other.residual, other.traps, other.dh);
...
% initial rates
selectedResultsMultiplot(Gt, reports_init, [11 21 41], ...
                         'background', 'totalCO2', ...
                         'plot_traps', true);

% optimized rates
selectedResultsMultiplot(Gt, reports_optim, [11 21 41], ...
                         'background', 'totalCO2', ...
                         'plot_traps', true);

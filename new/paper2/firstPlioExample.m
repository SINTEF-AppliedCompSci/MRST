...
migrateInjection(Gt, ta, petrodata, 5280, ...
                 'amount',      10, ... % Mt/year
                 'T_injection', 50*year,   ...
                 'T_migration', 50*year, ...
...
migrateInjection(Gt, ta, petrodata, 5280, ...
                 'amount',      10, ... % Mt/year
                 'T_injection', 50*year,   ...
                 'T_migration', 2450*year, ...
                 'topPressure', 100*barsa, ...
                 'Ni',          25,   ... % time steps during injection
                 'Nm',          245,  ... % time steps during migration
                 'plotPanel',   true, ...
                 'plotHist',    true);
...
annotation(gcf,'textarrow',[0.225 0.14], [0.18 0.11], ...
   'TextEdgeColor','none', 'String',{'Injection stops'});
annotation(gcf,'textarrow',[0.581 0.581], [0.20 0.11], ...
   'TextEdgeColor','none', 'String',{'Plume reaches','upper boundary'});
annotation(gcf,'arrow',[0.58 0.58], [0.29 0.92]);
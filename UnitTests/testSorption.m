function [pass] = testSorption()
%TESTSORPTION Summary of this function goes here
%   Detailed explanation goes here
    ...
    load('ws1sorb.mat')
    load('states1sorb.mat')
    load('ws2sorb.mat')
    load('states2sorb.mat')

    wsStructRef = vertcat(ws1sorb{:});

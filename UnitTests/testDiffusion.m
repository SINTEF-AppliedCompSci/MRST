function [pass] = testDiffusion()
%TESTDIFFUSION Summary of this function goes here
%   Detailed explanation goes here
    ...
    load('ws1diff.mat')
    load('states1diff.mat')
    load('ws2diff.mat')
    load('states2diff.mat')

    wsStructRef = vertcat(ws1diff{:});

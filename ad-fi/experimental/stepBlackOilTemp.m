function [state, meta] = stepBlackOilTemp(state0, state, meta, dt, G, W, system, fluid, varargin)
...
along with MRST.  If not, see <http://www.gnu.org/licenses/>.
   ...
   % Check convergence
   [converged, CNV, MB] = getConvergence(state, eqs, system.fluid, system, dt);
   ...
   if searchfail
      ...
      [state, nInc] = system.updateState(W, state, dx, system.fluid, system);
   end

...
opt = struct('tol_mb',              1e-7,...
             ...
             'relaxInc',            .1,...
             'pscale',              1,...
             'well_allowControlSwitching', false, ...
             'well_allowWellSignChange', false, ...
             'well_allowCrossFlow', false, ...
             'linesearch',          false,...
             'lineRelTol',          .99,...
             'lineIter',            10,...
             'cprRelTol',           1e-3,...
...
system.well.allowControlSwitching = opt.well_allowControlSwitching;
system.well.allowWellSignChange = opt.well_allowWellSignChange;
system.well.allowCrossFlow = opt.well_allowCrossFlow;
